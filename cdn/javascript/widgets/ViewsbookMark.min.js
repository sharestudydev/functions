...
function Rc(a,b){J(!b||!0===a||!1===a,"Can't turn on custom loggers persistently.");!0===a?("undefined"!==typeof console&&("function"===typeof console.log?yb=q(console.log,console):"object"===typeof console.log&&(yb=function(a){console.log(a)})),b&&P.set("logging_enabled",!0)):a?yb=a:(yb=null,P.remove("logging_enabled"))}U.enableLogging=Rc;U.ServerValue={TIMESTAMP:{".sv":"timestamp"}};U.SDK_VERSION="2.2.1";U.INTERNAL=W;U.Context=Wh;U.TEST_ACCESS=Z;})();jQuery,$.each($(".post-view[data-id]"),function(a,c){var f=$(c).parent().find("#postviews").addClass("view-load"),b=new Firebase("https://ss-views-default-rtdb.firebaseio.com/"+$(c).attr("data-id"));b.once("value",function(d){var e=d.val(),h=!1;null==e&&(e={},e.value=0,e.url=window.location.href,e.id=$(c).attr("data-id"),h=!0),f.removeClass("view-load").text(e.value),e.value++,"/"!=window.location.pathname&&(h?b.set(e):b.child("value").set(e.value))})});
